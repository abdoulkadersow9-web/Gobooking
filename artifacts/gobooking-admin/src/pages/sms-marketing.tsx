    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-bold text-foreground tracking-tight">SMS Marketing</h2>
            <p className="text-sm text-muted-foreground">Campagnes SMS et notifications clients</p>
          </div>
        </div>

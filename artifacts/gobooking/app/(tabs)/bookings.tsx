...
const styles = StyleSheet.create({
  ...
  card:         {
    backgroundColor: "white", borderRadius: 26, padding: 24, marginBottom: 20,
    shadowColor: "#000", shadowOffset: { width: 0, height: 10 }, shadowOpacity: 0.08, shadowRadius: 28, elevation: 8,
  ...
  cardHeader:   { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 22 },
  refText:      { fontSize: 16, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.3 },
  dateText:     { fontSize: 12, fontFamily: "Inter_400Regular", color: "#64748B", marginTop: 4 },
  ...
  cityBlock:    { flex: 1 },
  timeText:     { fontSize: 32, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -1.5 },
  cityText:     { fontSize: 14, fontFamily: "Inter_500Medium", color: "#64748B", marginTop: 6 },
  ...
  amountText:   { fontSize: 24, fontFamily: "Inter_700Bold", letterSpacing: -0.8 },

  ctaBtn:       { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 10, marginTop: 18, borderRadius: 18, paddingVertical: 17, shadowColor: "#000", shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.12, shadowRadius: 12, elevation: 5 },

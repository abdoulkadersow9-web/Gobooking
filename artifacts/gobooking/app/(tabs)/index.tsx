...
const styles = StyleSheet.create({
  ...
  // Quick CTAs
  ctaRow: { paddingHorizontal: 20, paddingTop: 36, gap: 14 },
  ctaBtn: {
    flexDirection: "row",
    alignItems: "center",
    gap: 18,
  ...
  ctaBtnPrimary: { backgroundColor: "white", borderWidth: 1.5, borderColor: "#C8D9FA", borderLeftWidth: 5, borderLeftColor: "#1650D0" },
  ctaBtnGreen:   { backgroundColor: "white", borderWidth: 1.5, borderColor: "#B0E4CE", borderLeftWidth: 5, borderLeftColor: "#059669" },
  ctaIcon: { width: 58, height: 58, borderRadius: 20, backgroundColor: "#EEF4FF", justifyContent: "center", alignItems: "center" },
  ctaText: { flex: 1 },
  ctaTitle: { fontSize: 17, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.3 },
  ctaSub:   { fontSize: 13, fontFamily: "Inter_400Regular", color: "#64748B", marginTop: 4, lineHeight: 20 },
  ...
  // Section divider
  sectionDivider: { height: 14, backgroundColor: "#D8DBF0", marginVertical: 8 },

  // Activity section
  section: { paddingHorizontal: 20, paddingTop: 36, paddingBottom: 16 },
  sectionHeader: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginBottom: 20 },
  sectionTitle: {
    fontSize: 21, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.6,
  ...
  quickLabel: { fontSize: 15, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.3 },
  quickSub: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.light.textSecondary, lineHeight: 19 },

  // Dashboard shortcut cards
  dashCard: { flexDirection: "row", alignItems: "center", gap: 16, backgroundColor: "white", borderRadius: 22, padding: 20, marginBottom: 14, shadowColor: "#000", shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.07, shadowRadius: 18, elevation: 5, borderWidth: 1, borderColor: "#ECEEF8" },
  dashCardIcon: { width: 54, height: 54, borderRadius: 18, justifyContent: "center", alignItems: "center", flexShrink: 0 },
  dashCardText: { flex: 1 },
  dashCardTitle: { fontSize: 16, fontFamily: "Inter_700Bold", letterSpacing: -0.2 },
  dashCardSub: { fontSize: 12, fontFamily: "Inter_400Regular", color: Colors.light.textSecondary, marginTop: 3, lineHeight: 18 },
  ...
  routeCard: {
    ...
    shadowColor: "#000", shadowOffset: { width: 0, height: 7 }, shadowOpacity: 0.07, shadowRadius: 22, elevation: 5,
  ...
  routeCardRoute: { fontSize: 16, fontFamily: "Inter_700Bold", color: "#0F172A", letterSpacing: -0.3 },
  ...
  routeCardPrice: { fontSize: 17, fontFamily: "Inter_700Bold", color: Colors.light.primary },
});

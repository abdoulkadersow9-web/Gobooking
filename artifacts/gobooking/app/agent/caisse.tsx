...
const S = StyleSheet.create({
  ...
  totalCard:     { marginHorizontal: 16, marginVertical: 14, borderRadius: 20, borderWidth: 1.5, padding: 22, flexDirection: "row", alignItems: "center", shadowColor: "#000", shadowOpacity: 0.06, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 4 },
  totalLabel:    { fontSize: 11, fontWeight: "800", letterSpacing: 0.8 },
  totalAmount:   { fontSize: 34, fontWeight: "900", marginTop: 5, letterSpacing: -0.5 },
  totalSub:      { fontSize: 13, marginTop: 4, opacity: 0.7 },
  totalIcon:     { width: 60, height: 60, borderRadius: 30, alignItems: "center", justifyContent: "center" },
  payCard:       { backgroundColor: "#fff", borderRadius: 16, overflow: "hidden", borderWidth: 1, borderColor: "#E5E7EB", shadowColor: "#000", shadowOpacity: 0.04, shadowRadius: 8, elevation: 2 },
  payRow:        { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingHorizontal: 16, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
  statRow:       { flexDirection: "row", alignItems: "center", paddingHorizontal: 16, paddingVertical: 13, borderBottomWidth: 1, borderBottomColor: "#F3F4F6" },
  ...
  tripInfoCard:  { backgroundColor: "#fff", borderRadius: 14, padding: 16, borderLeftWidth: 4, borderWidth: 1, borderColor: "#E5E7EB" },
  closeBtn:      { flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 8, paddingVertical: 16, borderRadius: 16, marginTop: 4 },
  closeBtnText:  { fontSize: 15, fontWeight: "800", color: "#fff" },
  emptyTx:       { alignItems: "center", paddingVertical: 44 },
  txRow:         { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", borderRadius: 14, padding: 13, marginBottom: 8, borderWidth: 1, borderColor: "#EEF0F6", gap: 12, shadowColor: "#000", shadowOpacity: 0.03, shadowRadius: 6, elevation: 1 },
  ...
  histCard:      { backgroundColor: "#fff", borderRadius: 16, padding: 16, marginBottom: 10, borderWidth: 1, borderColor: "#EEF0F6", shadowColor: "#000", shadowOpacity: 0.04, shadowRadius: 8, elevation: 2 },

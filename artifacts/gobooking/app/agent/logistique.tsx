...
const S = StyleSheet.create({
  ...
  depCard:   { backgroundColor: "#fff", borderRadius: 16, padding: 14, shadowColor: "#1650D0", shadowOpacity: 0.07, shadowRadius: 12, shadowOffset: { width: 0, height: 4 }, elevation: 4, borderWidth: 1, borderColor: "#EEF2FF" },
  depTop:    { flexDirection: "row", alignItems: "flex-start", gap: 12 },
  depIconBox:{ width: 40, height: 40, borderRadius: 12, backgroundColor: BLUE_L, justifyContent: "center", alignItems: "center" },
  depRoute:  { fontSize: 14, fontWeight: "800", color: "#0F172A" },
  depSub:    { fontSize: 11, color: "#64748B", marginTop: 2, fontWeight: "500" },

  busCard:    { backgroundColor: "#fff", borderRadius: 18, padding: 16, shadowColor: "#1650D0", shadowOpacity: 0.08, shadowRadius: 14, shadowOffset: { width: 0, height: 5 }, elevation: 5, gap: 12, borderWidth: 1, borderColor: "#EEF2FF" },
  busTop:     { flexDirection: "row", alignItems: "flex-start", gap: 14 },
  busIconBox: { width: 44, height: 44, borderRadius: 13, backgroundColor: BLUE_L, justifyContent: "center", alignItems: "center" },
  busName:    { fontSize: 15, fontWeight: "800", color: "#0F172A" },
  busPlate:   { fontSize: 11, color: "#64748B", marginTop: 1, fontWeight: "600" },
  busLoc:     { fontSize: 11, color: "#64748B", marginTop: 2, fontWeight: "500" },

...
const ALL_MODULES = [
  ...
  {
    id: "baggage",
    label: "Validation Bagages",
    sub: "Contrôle des bagages",
    desc: "Valider ou refuser les photos de bagages des passagers (≥2 bagages)",
    icon: "briefcase" as const,
    emoji: "🧳",
    path: "/agent/baggage-review",
    color: "#B45309",
    gradient: ["#FFFBEB", "#FEF3C7"] as [string, string],
    border: "#FDE68A",
    roles: ["embarquement", "vente", "agent_embarquement", "vente_billets"],
  },
  {
    id: "logistique",

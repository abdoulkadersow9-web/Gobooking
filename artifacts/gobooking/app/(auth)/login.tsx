...
const ROLE_STYLES: Record<string, RoleStyle> = {
  ...
  agent_colis:        { label: "Agent Colis",    icon: "package",      color: "#5B21B6", bg: "#EDE9FE", order: 5  },
  agent_route:        { label: "Agent Route",    icon: "navigation",   color: "#B45309", bg: "#FEF3C7", order: 6  },
  validation_depart:  { label: "Validation",     icon: "check-square", color: "#0E7490", bg: "#ECFEFF", order: 7  },
  logistique:         { label: "Logistique",     icon: "truck",        color: "#166534", bg: "#D1FAE5", order: 8  },
  suivi:              { label: "Suivi",          icon: "map-pin",      color: "#9A3412", bg: "#FEF3C7", order: 9  },
  client:             { label: "Client",         icon: "user",         color: "#0891B2", bg: "#F0F9FF", order: 10 },
  user:               { label: "Client",         icon: "user",         color: "#0891B2", bg: "#F0F9FF", order: 10 },
};

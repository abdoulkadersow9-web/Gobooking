...
- **Agent System**:
    ...
    - **Module 5 — Agent Guichet · Impression Départ**: `guichet-impression.tsx`; NO new API (reuses /agent/validation-depart/*); adds expenses (péage, ration équipage, carburant, entretien) → auto-visible on validation bordereau; prints Route PDF (NO amounts) via expo-print; menu entry added to guichet/vente/agent_ticket roles.
